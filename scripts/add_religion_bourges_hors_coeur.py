...
"""
Add a Religion event to four Bourges (Cher) people outside the Jacques
Coeur lot already written the same day - all before 1793, all
individually checked not living.

Pierre Coeur (I1690, father of Jacques Coeur, died 1435) was missed by
the earlier Coeur lot and belongs with it. Francois and Bernardin
Bochetel (I1747, I1749) are sourced by C0925, an AD18 archival citation
distinct from C0190 (the Ovaere-tree source disqualified the same day
for the Coeur/Bochetel descendants chain) - their own religion is not
affected by that disqualification even though their note says our
lineage passes through Francois Bochetel's sister, not through him
directly. Francois Jacquet (I0952) has direct evidence: his act names
"Jolivet, archipretre de Bourges".

Two people found in the same search were excluded: Anne Barat (I1762,
only source is the disqualified C0190) and Jeanne Desmouliere (I1118,
a derived Geneanet citation flagged "sans reproduction d'acte" plus an
unresolved homonymy note nearby).
...
LOT = [
    {
        ...
        "citation": "C0185",
        "evidence": (
            "Pierre Coeur (pere de Jacques Coeur): mort 1435, Bourges - "
            "manquait au lot Jacques Coeur deja ecrit, meme certitude "
            "historique (avant la Reforme)"
        ),
    },
    {
        "gramps_id": "I1747",
        ...
        "citation": "C0925",
        "evidence": (
            "Francois Bochetel: echevin de Bourges 1484, maire 1494 - "
            "source archivistique primaire AD18 2F160, distincte de "
            "C0190"
        ),
    },
    {
        ...
        "citation": "C0925",
        "evidence": (
            "Bernardin Bochetel: procureur general 1501, maire de "
            "Bourges 1505, meme source archivistique C0925"
        ),
    },
    {
        "gramps_id": "I0952",
        ...
        "citation": "C0652",
        "evidence": (
            "Francois Jacquet: mort 1785 a Saint-Doulchard, acte "
            "primaire nommant explicitement Jolivet, archipretre de "
            "Bourges"
        ),
    },
]

DESCRIPTION = "Catholique (Bourges, Cher, avant 1793)"

NOTE_TEXT = (
    "[CLOS] Religion catholique pour quatre personnes de Bourges (Cher) "
    "hors du lot Jacques Coeur deja ecrit le 21/09/2026.\n\n"
    "Pierre Coeur (I1690), pere de Jacques Coeur, avait ete oublie du "
    "lot Coeur/Bourges initial - meme certitude historique (avant la "
    "Reforme de 1517). Francois et Bernardin Bochetel (I1747, I1749) "
    "sont sources par C0925, une piece d'archives (AD18 2F160) "
    "DIFFERENTE de C0190 (la source Ovaere disqualifiee le meme jour "
    "pour la chaine de descendance Coeur/Bochetel) - leur propre "
    "religion n'est pas affectee par cette disqualification, meme si "
    "leur note precise que notre lignee passe par la soeur de Francois, "
    "pas par lui directement. Francois Jacquet (I0952) a une preuve "
    "directe : son acte nomme Jolivet, archipretre de Bourges.\n\n"
    "Exclus (trouves dans la meme recherche) : Anne Barat (I1762, seule "
    "source = C0190 disqualifiee) et Jeanne Desmouliere (I1118, "
    "citation Geneanet derivee 'sans reproduction d'acte', plus "
    "homonymie non resolue signalee a proximite).\n\n"
